  ...
  return $.ajax(API + "pools")
    .done(function(data) {
      ...
      $.each(data.pools, function(index, value) {
		...
		var payoutScheme = value.paymentProcessing.payoutScheme;
		...
		poolCoinTableTemplate += "<td class='payout-scheme'>" + payoutScheme + "</td>";
    ...
    .fail(function() {
	  ...
	  poolCoinTableTemplate += "<tr><td colspan='9'> ";
